...
<link rel="stylesheet"
	href="<c:url value='/resources/css/teacher/teacherAttendance.css'/>">
</head>
<body>
	...
	<div class="attendance-container">
				...
				<c:forEach var="attendance" items="${attendanceList}">
					<tr>
						...
						<td><label> <input type="radio"
								name="attendance_${attendance.stuId}" value="TA"> 지각
						</label></td>
						<td><label> <input type="radio"
								name="attendance_${attendance.stuId}" value="AB"> 결석
						</label></td>
						<td><label> <input type="radio"
								name="attendance_${attendance.stuId}" value="AT" checked>
								출석
						</label></td>
					</tr>
				</c:forEach>
		...
		<button type="button" class="update_button"
			onclick="updateAttendance()">수정</button>
	</div>

	<script
		src="<c:url value='/resources/js/teacher/teacherAttendance.js'/>"></script>
